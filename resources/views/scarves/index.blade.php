...
@section('main')
    ...
    <form action="{{ route('scarves.index') }}" method="get">
        <input type="hidden" id="with_diagonal" name="with_diagonal" value="0">
        ...
        <input type="hidden" id="without_diagonal" name="without_diagonal" value="0">
        ...
        <input type="hidden" id="with_border" name="with_border" value="0">
        ...
        <input type="hidden" id="without_border" name="without_border" value="0">
        ...
        <input type="hidden" id="with_image" name="with_image" value="0">
        ...
        <input type="hidden" id="without_image" name="without_image" value="0">
