...
@section('body')
    <div class="parallax">
        ...
        <header>
            ...
            <img alt="" src="{{ asset('images/banner1.jpg') }}" class="background">
            <img alt="{{ __('A patrol of scouts walking in nature on a sunny day') }}" src="{{ asset('images/banner1_foreground.png') }}" class="foreground">
        </header>
